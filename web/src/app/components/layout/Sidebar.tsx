  ...
  if (performanceMode) {
    return (
      <>
        {open && (
          <div
            className='fixed inset-y-0 left-64 right-0 bg-black/20 z-40 md:hidden'
            aria-hidden='true'
            onClick={onClose}
          />
        )}
        <div
          ...
          style={{ width: open ? '16rem' : 0, overflow: 'hidden' }}
        >
          <div className='w-64 flex flex-col items-stretch h-full z-30 relative float-right p-4'>
            ...
            <div className='overflow-y-auto flex flex-col flex-1 px-2'>
              <nav className='flex flex-col gap-2'>
                {menuItems.map((item) => (
                  <NavLink
                    ...
                    children={({ isActive }) => (
                      <div className={`flex items-center w-full text-left justify-start rounded-lg px-3 py-2.5 text-sm ${
                        isActive
                        ...
                        <div className={`w-3 h-1.5 rounded-full ml-auto ${
                          isActive
              ...
              <div className='mt-auto mb-10 md:mb-0 space-y-3 px-2'>
                <button
                  className='w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium bg-[#165DFF]/10 hover:bg-[#165DFF]/20 text-[#165DFF] shadow-sm hover:shadow-md backdrop-blur-sm dark:bg-white/[0.06] dark:hover:bg-white/[0.12] dark:text-gray-300 dark:shadow-none'
                  onClick={toggleTheme}
                >
                ...
                <button
                  className='w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-full text-sm font-medium bg-red-50/50 hover:bg-red-100/80 dark:bg-red-500/10 dark:hover:bg-red-500/20 text-red-500 shadow-sm hover:shadow-md backdrop-blur-sm'
