...
export const CUSTOM_BLOCKS = [
  ...
  {
    type: 'group_get_shut_list',
    message0: '获取群 %1 被禁言成员列表',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Array',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群中被禁言的成员列表\n输入：群号 - 数字或字符串\n输出：数组（被禁言成员信息列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_get_at_all_remain',
    message0: '获取群 %1 @全体成员剩余次数',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Number',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群中@全体成员的剩余次数\n输入：群号 - 数字或字符串\n输出：数字（剩余次数）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_set_remark',
    message0: '设置群 %1 的备注为 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
  ...
  {
    type: 'group_set_msg_recv',
    message0: '设置群 %1 消息接收方式为 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
      {
        type: 'field_dropdown',
    ...
    nextStatement: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：设置群消息接收方式\n输入：群号 - 数字或字符串；模式 - 下拉选择\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_sign_in',
  ...
  {
    type: 'group_get_filtered_requests',
    message0: '获取群 %1 被过滤的加群请求',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Array',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群中被过滤的加群请求列表\n输入：群号 - 数字或字符串（可选，不传则获取所有群的）\n输出：数组（被过滤的加群请求列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_send_notice',
    message0: '发送群 %1 公告 内容 %2 图片 %3 弹窗 %4 引导修改昵称 %5 发给新成员 %6',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'CONTENT', check: 'String' },
    ...
    nextStatement: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：发送群公告（V7.12.5+ 增强版）\n输入：群号 - 数字或字符串；内容 - 字符串；图片 - 字符串（可选）；弹窗 - 布尔值；引导修改昵称 - 布尔值；发给新成员 - 布尔值\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_get_notice',
    message0: '获取群 %1 公告列表',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Array',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群公告列表（V7.12.5+ 增强版）\n输入：群号 - 数字或字符串\n输出：数组（公告列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_delete_notice',
    message0: '删除群 %1 公告 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
  ...
  {
    type: 'group_set_avatar',
    message0: '设置群 %1 头像为 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ...
    nextStatement: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：设置群头像\n输入：群号 - 数字或字符串；文件路径 - 字符串\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_create_album',
    message0: '在群 %1 创建相册 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'NAME', check: 'String' },
    ],
    ...
    nextStatement: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：创建群相册\n输入：群号 - 数字或字符串；相册名称 - 字符串\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_delete_album',
    message0: '删除群 %1 相册 %2',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
  ...
  {
    type: 'group_get_album_media_list',
    message0: '获取群 %1 相册 %2 媒体列表',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'ALBUM_ID', check: 'String' },
    ],
    output: 'Array',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群相册媒体列表（V7.12.3+）\n输入：群号 - 数字或字符串；相册ID - 字符串\n输出：数组（媒体列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_upload_album',
    message0: '上传群 %1 相册 %2 文件 %3 是否视频 %4',
    args0: [
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'ALBUM_ID', check: 'String' },
      { type: 'input_value', name: 'FILE', check: 'String' },
    ...
    nextStatement: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：上传群相册（V7.12.5+ 支持视频）\n输入：群号 - 数字或字符串；相册ID - 字符串；文件路径 - 字符串；是否视频 - 布尔值\n输出：无',
    helpUrl: HELP_URL.block,
  },
  // ========== 好友管理积木 ==========
  {
  ...
  {
    type: 'user_move_friend',
    message0: '移动好友 %1 到分组 %2',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    ...
    nextStatement: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：移动好友到指定分组\n输入：用户ID - 数字或字符串；分组ID - 数字或字符串\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_get_who_liked_me',
    message0: '获取谁赞过我列表',
    output: 'Array',
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取谁赞过我的列表\n输入：无\n输出：数组（赞过我的人列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_get_who_i_liked',
    message0: '获取我赞过谁列表',
    output: 'Array',
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取我赞过谁的列表\n输入：无\n输出：数组（我赞过的人列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_get_filtered_requests',
    message0: '获取被过滤的好友请求',
    output: 'Array',
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取被过滤的好友请求列表\n输入：无\n输出：数组（被过滤的好友请求列表）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_handle_filtered_request',
    message0: '处理被过滤好友请求 用户 %1 同意 %2 备注 %3',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
      {
        type: 'field_dropdown',
    ...
    nextStatement: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：处理被过滤的好友请求\n输入：用户ID - 数字或字符串；同意 - 布尔值；备注 - 字符串\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_get_qq_avatar',
    message0: '获取 %1 的头像 是群头像 %2',
    args0: [
      { type: 'input_value', name: 'ID', check: ['Number', 'String'] },
      {
        type: 'field_dropdown',
        name: 'IS_GROUP',
        options: [
    ...
    output: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取QQ或群头像URL\n输入：ID - 数字或字符串；是群头像 - 布尔值\n输出：对象（包含 success、data 等字段）',
    helpUrl: HELP_URL.block,
  },
  // ========== 会员信息积木 ==========
  {
    type: 'user_get_vip_info',
    message0: '获取用户 %1 的会员信息',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
    ],
    output: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取用户的会员信息（V7.12.9+）\n输入：用户ID - 数字或字符串\n输出：对象（包含 is_vip、is_yearly_vip、vip_level 等字段）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_is_vip',
    ...
    output: 'Boolean',
    colour: COLOR_HUE.user,
    tooltip: '介绍：判断用户是否为会员（V7.12.9+）\n输入：用户ID - 数字或字符串\n输出：布尔值（true=是会员，false=不是会员）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_is_yearly_vip',
    message0: '用户 %1 是年费会员',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
    ],
    output: 'Boolean',
    colour: COLOR_HUE.user,
    tooltip: '介绍：判断用户是否为年费会员（V7.12.9+）\n输入：用户ID - 数字或字符串\n输出：布尔值（true=是年费会员，false=不是年费会员）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'user_get_vip_level',
    message0: '获取用户 %1 的会员等级',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
    ],
    output: 'Number',
    colour: COLOR_HUE.user,
    tooltip: '介绍：获取用户的会员等级（V7.12.9+）\n输入：用户ID - 数字或字符串\n输出：数字（会员等级，如 1-8）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_member_is_vip',
    message0: '群成员 %1 在群 %2 中是会员',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Boolean',
    colour: COLOR_HUE.group,
    tooltip: '介绍：判断群成员是否为会员（V7.12.9+）\n输入：用户ID - 数字或字符串；群号 - 数字或字符串\n输出：布尔值（true=是会员，false=不是会员）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_member_get_vip_level',
    message0: '获取群成员 %1 在群 %2 中的会员等级',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    output: 'Number',
    colour: COLOR_HUE.group,
    tooltip: '介绍：获取群成员的会员等级（V7.12.9+）\n输入：用户ID - 数字或字符串；群号 - 数字或字符串\n输出：数字（会员等级，如 1-8）',
    helpUrl: HELP_URL.block,
  },
  // ========== 信息解析积木 ==========
  {
    type: 'data_get_field',
    message0: '从数据 %1 中获取字段 %2',
    args0: [
    ...
    tooltip: '介绍：从API返回的数据对象中提取指定字段\n输入：数据 - 对象（如API响应的data字段）；字段 - 字符串（如 "nickname"、"is_vip"）\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'stranger_info_get_field',
    message0: '从陌生人信息 %1 中获取 %2',
    args0: [
      { type: 'input_value', name: 'DATA', check: 'Object' },
      {
        type: 'field_dropdown',
    ...
    output: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：从陌生人信息数据中提取指定字段（V7.12.9+）\n输入：数据 - 对象（user.get_stranger_info返回的data字段）；字段 - 下拉选择\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_member_info_get_field',
    message0: '从群成员信息 %1 中获取 %2',
    args0: [
      { type: 'input_value', name: 'DATA', check: 'Object' },
      {
        type: 'field_dropdown',
    ...
    output: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：从群成员信息数据中提取指定字段\n输入：数据 - 对象（group.get_member_info返回的data字段）；字段 - 下拉选择\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'group_info_get_field',
    message0: '从群信息 %1 中获取 %2',
    args0: [
      { type: 'input_value', name: 'DATA', check: 'Object' },
      {
        type: 'field_dropdown',
        ...
        options: [
          ...
          ['群名', 'group_name'],
          ['成员数', 'member_count'],
          ['最大成员数', 'max_member_count'],
          ['群主', 'owner_id'],
          ['群备注', 'remark'],
          ['创建时间', 'create_time'],
          ['群等级', 'group_level'],
          ['群人数上限', 'max_member_count'],
        ],
      },
    ],
    output: null,
    colour: COLOR_HUE.group,
    tooltip: '介绍：从群信息数据中提取指定字段\n输入：数据 - 对象（group.get_info返回的data字段）；字段 - 下拉选择\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'friend_info_get_field',
    message0: '从好友信息 %1 中获取 %2',
    args0: [
      { type: 'input_value', name: 'DATA', check: 'Object' },
      {
        type: 'field_dropdown',
    ...
    output: null,
    colour: COLOR_HUE.user,
    tooltip: '介绍：从好友信息数据中提取指定字段\n输入：数据 - 对象（user.get_friend_info返回的data字段）；字段 - 下拉选择\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'msg_info_get_field',
    message0: '从消息详情 %1 中获取 %2',
    args0: [
      { type: 'input_value', name: 'DATA', check: 'Object' },
      {
        type: 'field_dropdown',
    ...
    output: null,
    colour: COLOR_HUE.message,
    tooltip: '介绍：从消息详情数据中提取指定字段（V7.12.3+ 支持status字段）\n输入：数据 - 对象（message.get_msg返回的data字段）；字段 - 下拉选择\n输出：字段对应的值',
    helpUrl: HELP_URL.block,
  },
  // ========== 消息操作积木 ==========
  {
  ...
  {
    type: 'system_set_login_info',
    message0: '设置登录号资料 昵称 %1 签名 %2 性别 %3 年龄 %4',
    args0: [
      { type: 'input_value', name: 'NICKNAME', check: 'String' },
      { type: 'input_value', name: 'SIGN', check: 'String' },
      {
        type: 'field_dropdown',
        name: 'SEX',
        options: [
      ...
      { type: 'input_value', name: 'AGE', check: 'Number' },
    ],
    previousStatement: null,
    nextStatement: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：设置登录号资料\n输入：昵称 - 字符串；签名 - 字符串；性别 - 下拉选择；年龄 - 数字\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'system_set_online_status',
    message0: '设置在线状态为 %1 扩展状态 %2',
    args0: [
      { type: 'input_value', name: 'STATUS', check: 'Number' },
      { type: 'input_value', name: 'EXT_STATUS', check: 'String' },
    ],
    previousStatement: null,
    nextStatement: null,
    colour: COLOR_HUE.system,
  ...
  {
    type: 'system_set_input_status',
    message0: '设置输入状态 用户 %1 群号 %2',
    args0: [
      { type: 'input_value', name: 'USER_ID', check: ['Number', 'String'] },
      { type: 'input_value', name: 'GROUP_ID', check: ['Number', 'String'] },
    ],
    ...
    nextStatement: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：设置输入状态（V7.12.3+）\n输入：用户ID - 数字或字符串；群号 - 数字或字符串（可选）\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'system_send_protobuf',
    message0: '发送Protobuf数据包 命令 %1 数据 %2',
    args0: [
    ...
    nextStatement: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：发送Protobuf数据包\n输入：命令 - 字符串；数据 - 字符串（Base64编码）\n输出：无',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'system_get_recommended_faces',
    message0: '获取推荐表情',
    output: 'Array',
    colour: COLOR_HUE.system,
    tooltip: '介绍：获取推荐表情列表\n输入：无\n输出：数组（推荐表情列表）',
  ...
  {
    type: 'system_get_favorite_faces',
    message0: '获取收藏表情',
    output: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：获取收藏表情列表\n输入：无\n输出：对象（包含 success、data 等字段）',
  ...
  {
    type: 'system_download_file',
    message0: '下载文件到缓存 URL %1 校验值 %2 文件名 %3',
    args0: [
      { type: 'input_value', name: 'URL', check: 'String' },
      { type: 'input_value', name: 'BASE64_HASH', check: 'String' },
      { type: 'input_value', name: 'NAME', check: 'String' },
    ],
    output: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：下载文件到缓存目录\n输入：URL - 字符串；校验值 - 字符串（可选）；文件名 - 字符串（可选）\n输出：对象（包含 success、data 等字段）',
    helpUrl: HELP_URL.block,
  },
  {
    type: 'system_get_official_bot_range',
    message0: '获取官方机器人QQ号范围',
    output: null,
    colour: COLOR_HUE.system,
    tooltip: '介绍：获取官方机器人QQ号范围\n输入：无\n输出：对象（包含 success、data 等字段）',
    helpUrl: HELP_URL.block,
  },
  // ========== 请求处理积木 ==========
  {
