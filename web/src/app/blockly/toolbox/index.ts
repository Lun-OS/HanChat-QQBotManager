  ...
  return {
    ...
    contents: [
      ...
      category('消息', 'message_category', [
        ...
        subCategory('信息解析', 'message_category', [
          block('data_get_field'),
          block('msg_info_get_field'),
        ]),
      ...
      category('群组', 'group_category', [
        subCategory('群信息', 'group_category', [
          ...
          block('group_get_shut_list'),
          block('group_get_at_all_remain'),
          block('group_get_album_list'),
          block('group_get_album_media_list'),
          block('group_get_filtered_requests'),
        ...
        subCategory('群成员会员', 'group_category', [
          block('group_member_is_vip'),
          block('group_member_get_vip_level'),
        ]),
        subCategory('信息解析', 'group_category', [
          block('data_get_field'),
          block('group_member_info_get_field'),
          block('group_info_get_field'),
        ]),
        ...
        subCategory('群设置', 'group_category', [
          ...
          block('group_set_remark'),
          block('group_set_msg_recv'),
          block('group_sign_in'),
          block('group_set_avatar'),
        ...
        subCategory('群公告', 'group_category', [
          block('group_send_notice'),
          block('group_get_notice'),
          block('group_delete_notice'),
        ...
        subCategory('群相册', 'group_category', [
          block('group_create_album'),
          block('group_delete_album'),
          block('group_upload_album'),
      ...
      category('用户', 'user_category', [
        subCategory('好友管理', 'user_category', [
          ...
          block('user_poke'),
          block('user_move_friend'),
          block('user_get_who_liked_me'),
          block('user_get_who_i_liked'),
          block('user_get_filtered_requests'),
          block('user_handle_filtered_request'),
          block('user_get_qq_avatar'),
        ...
        subCategory('会员信息', 'user_category', [
          block('user_get_vip_info'),
          block('user_is_vip'),
          block('user_is_yearly_vip'),
          block('user_get_vip_level'),
        ]),
        subCategory('信息解析', 'user_category', [
          block('data_get_field'),
          block('stranger_info_get_field'),
          block('friend_info_get_field'),
        ]),
      ...
      category('系统', 'system_category', [
        ...
        subCategory('系统操作', 'system_category', [
          block('system_status'),
          block('system_set_login_info'),
          block('system_set_online_status'),
          block('system_set_input_status'),
          block('system_send_protobuf'),
          block('system_get_recommended_faces'),
          block('system_get_favorite_faces'),
          block('system_get_rkey'),
          block('system_download_file'),
          block('system_get_official_bot_range'),
