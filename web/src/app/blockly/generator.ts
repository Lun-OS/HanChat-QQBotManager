...
`;
  ...
  generator.forBlock['onebot_get_qq_avatar'] = function(block: Blockly.Block) {
    ...
    return [`user.get_qq_avatar(${id}, ${isGroup})`, generator.ORDER_HIGH];
  };
  ...
  generator.forBlock['onebot_get_rkey'] = function(block: Blockly.Block) {
    return [`system.get_rkey()`, generator.ORDER_HIGH];
  };
  ...
  // ========== V7.12.3+ 新增群管理积木生成器 ==========
  generator.forBlock['group_get_shut_list'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`group.get_shut_list(${groupId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_get_at_all_remain'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`group.get_at_all_remain(${groupId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_set_remark'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const remark = generator.valueToCode(block, 'REMARK', generator.ORDER_NONE) || '""';
    return `group.set_remark(${groupId}, ${remark})\n`;
  };

  generator.forBlock['group_set_msg_recv'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const mode = block.getFieldValue('MODE') || '1';
    return `group.set_msg_recv(${groupId}, "${mode}")\n`;
  };

  generator.forBlock['group_sign_in'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return `group.sign_in(${groupId})\n`;
  };

  generator.forBlock['group_get_filtered_requests'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`group.get_filtered_requests(${groupId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_send_notice'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const content = generator.valueToCode(block, 'CONTENT', generator.ORDER_NONE) || '""';
    const image = generator.valueToCode(block, 'IMAGE', generator.ORDER_NONE) || '""';
    const popup = block.getFieldValue('POPUP') === 'TRUE';
    const tip = block.getFieldValue('TIP') === 'TRUE';
    const newMember = block.getFieldValue('NEW_MEMBER') === 'TRUE';
    return `group.send_notice(${groupId}, ${content}, ${image}, ${popup}, ${tip}, ${newMember})\n`;
  };

  generator.forBlock['group_get_notice'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`group.get_notice(${groupId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_delete_notice'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const noticeId = generator.valueToCode(block, 'NOTICE_ID', generator.ORDER_NONE) || '""';
    return `group.delete_notice(${groupId}, ${noticeId})\n`;
  };

  generator.forBlock['group_set_avatar'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const file = generator.valueToCode(block, 'FILE', generator.ORDER_NONE) || '""';
    return `group.set_avatar(${groupId}, ${file})\n`;
  };

  generator.forBlock['group_create_album'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const name = generator.valueToCode(block, 'NAME', generator.ORDER_NONE) || '""';
    return `group.create_album(${groupId}, ${name})\n`;
  };

  generator.forBlock['group_delete_album'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const albumId = generator.valueToCode(block, 'ALBUM_ID', generator.ORDER_NONE) || '""';
    return `group.delete_album(${groupId}, ${albumId})\n`;
  };

  generator.forBlock['group_get_album_list'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`group.get_album_list(${groupId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_get_album_media_list'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const albumId = generator.valueToCode(block, 'ALBUM_ID', generator.ORDER_NONE) || '""';
    return [`group.get_album_media_list(${groupId}, ${albumId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_upload_album'] = function(block: Blockly.Block) {
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    const albumId = generator.valueToCode(block, 'ALBUM_ID', generator.ORDER_NONE) || '""';
    const file = generator.valueToCode(block, 'FILE', generator.ORDER_NONE) || '""';
    const isVideo = block.getFieldValue('IS_VIDEO') === 'TRUE';
    return `group.upload_album(${groupId}, ${albumId}, ${file}, ${isVideo})\n`;
  };

  // ========== V7.12.3+ 新增好友管理积木生成器 ==========
  generator.forBlock['user_move_friend'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return `user.move_friend(${userId}, ${groupId})\n`;
  };

  generator.forBlock['user_get_who_liked_me'] = function(block: Blockly.Block) {
    return [`user.get_who_liked_me()`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_get_who_i_liked'] = function(block: Blockly.Block) {
    return [`user.get_who_i_liked()`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_get_filtered_requests'] = function(block: Blockly.Block) {
    return [`user.get_filtered_requests()`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_handle_filtered_request'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    const approve = block.getFieldValue('APPROVE') === 'TRUE';
    const remark = generator.valueToCode(block, 'REMARK', generator.ORDER_NONE) || '""';
    return `user.handle_filtered_request(${userId}, ${approve}, ${remark})\n`;
  };

  generator.forBlock['user_get_qq_avatar'] = function(block: Blockly.Block) {
    const id = generator.valueToCode(block, 'ID', generator.ORDER_NONE) || '0';
    const isGroup = block.getFieldValue('IS_GROUP') === 'TRUE';
    return `user.get_qq_avatar(${id}, ${isGroup})\n`;
  };

  // ========== V7.12.9+ 会员信息积木生成器 ==========
  generator.forBlock['user_get_vip_info'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    return [`user.get_stranger_info(${userId})`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_is_vip'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    return [`(function() local r = user.get_stranger_info(${userId}); if r.success and r.data then return r.data.is_vip == true else return false end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_is_yearly_vip'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    return [`(function() local r = user.get_stranger_info(${userId}); if r.success and r.data then return r.data.is_yearly_vip == true else return false end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['user_get_vip_level'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    return [`(function() local r = user.get_stranger_info(${userId}); if r.success and r.data then return r.data.vip_level or 0 else return 0 end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_member_is_vip'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`(function() local r = group.get_member_info(${groupId}, ${userId}); if r.success and r.data then return r.data.is_vip == true else return false end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_member_get_vip_level'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return [`(function() local r = group.get_member_info(${groupId}, ${userId}); if r.success and r.data then return r.data.vip_level or 0 else return 0 end end)()`, generator.ORDER_HIGH];
  };
  ...
  generator.forBlock['data_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = generator.valueToCode(block, 'FIELD', generator.ORDER_NONE) || '""';
    return [`(function() local d = ${data}; if type(d) == "table" then return d[${field}] else return nil end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['stranger_info_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = block.getFieldValue('FIELD') || '';
    return [`(function() local d = ${data}; if type(d) == "table" then return d["${field}"] else return nil end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_member_info_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = block.getFieldValue('FIELD') || '';
    return [`(function() local d = ${data}; if type(d) == "table" then return d["${field}"] else return nil end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['group_info_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = block.getFieldValue('FIELD') || '';
    return [`(function() local d = ${data}; if type(d) == "table" then return d["${field}"] else return nil end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['friend_info_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = block.getFieldValue('FIELD') || '';
    return [`(function() local d = ${data}; if type(d) == "table" then return d["${field}"] else return nil end end)()`, generator.ORDER_HIGH];
  };

  generator.forBlock['msg_info_get_field'] = function(block: Blockly.Block) {
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '{}';
    const field = block.getFieldValue('FIELD') || '';
    return [`(function() local d = ${data}; if type(d) == "table" then return d["${field}"] else return nil end end)()`, generator.ORDER_HIGH];
  };

  // ========== V7.12.3+ 新增系统API积木生成器 ==========
  generator.forBlock['system_set_login_info'] = function(block: Blockly.Block) {
    const nickname = generator.valueToCode(block, 'NICKNAME', generator.ORDER_NONE) || '""';
    const sign = generator.valueToCode(block, 'SIGN', generator.ORDER_NONE) || '""';
    const sex = block.getFieldValue('SEX') || '';
    const age = generator.valueToCode(block, 'AGE', generator.ORDER_NONE) || '0';
    return `system.set_login_info(${nickname}, ${sign}, "${sex}", ${age})\n`;
  };

  generator.forBlock['system_set_online_status'] = function(block: Blockly.Block) {
    const status = generator.valueToCode(block, 'STATUS', generator.ORDER_NONE) || '0';
    const extStatus = generator.valueToCode(block, 'EXT_STATUS', generator.ORDER_NONE) || '""';
    return `system.set_online_status(${status}, ${extStatus})\n`;
  };

  generator.forBlock['system_set_input_status'] = function(block: Blockly.Block) {
    const userId = generator.valueToCode(block, 'USER_ID', generator.ORDER_NONE) || '0';
    const groupId = generator.valueToCode(block, 'GROUP_ID', generator.ORDER_NONE) || '0';
    return `system.set_input_status(${userId}, ${groupId})\n`;
  };

  generator.forBlock['system_send_protobuf'] = function(block: Blockly.Block) {
    const cmd = generator.valueToCode(block, 'CMD', generator.ORDER_NONE) || '""';
    const data = generator.valueToCode(block, 'DATA', generator.ORDER_NONE) || '""';
    return `system.send_protobuf(${cmd}, ${data})\n`;
  };

  generator.forBlock['system_get_recommended_faces'] = function(block: Blockly.Block) {
    return [`system.get_recommended_faces()`, generator.ORDER_HIGH];
  };

  generator.forBlock['system_get_favorite_faces'] = function(block: Blockly.Block) {
    return [`system.get_favorite_faces()`, generator.ORDER_HIGH];
  };

  generator.forBlock['system_get_rkey'] = function(block: Blockly.Block) {
    return [`system.get_rkey()`, generator.ORDER_HIGH];
  };

  generator.forBlock['system_download_file'] = function(block: Blockly.Block) {
    const url = generator.valueToCode(block, 'URL', generator.ORDER_NONE) || '""';
    const base64Hash = generator.valueToCode(block, 'BASE64_HASH', generator.ORDER_NONE) || '""';
    const name = generator.valueToCode(block, 'NAME', generator.ORDER_NONE) || '""';
    return [`system.download_file(${url}, ${base64Hash}, ${name})`, generator.ORDER_HIGH];
  };

  generator.forBlock['system_get_official_bot_range'] = function(block: Blockly.Block) {
    return [`system.get_official_bot_range()`, generator.ORDER_HIGH];
  };
}
