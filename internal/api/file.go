...
func RegisterFileRoutes(r *gin.RouterGroup, ll *services.LLOneBotService, base *zap.Logger) {
	...
	r.GET("/group/:groupId/fs-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群文件系统信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.GET("/group/:groupId/files", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群根目录文件列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.DELETE("/group/:groupId/file/:fileId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "删除群文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/group/:groupId/move-file", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "移动群文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/group/:groupId/create-folder", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "创建群文件文件夹失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.DELETE("/group/:groupId/folder/:folderId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "删除群文件文件夹失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.PUT("/group/:groupId/folder/:folderId/rename", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "重命名群文件文件夹失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.GET("/group/:groupId/folder/:folderId/files", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群子目录文件列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/group/:groupId/file/:fileId/url", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群文件资源链接失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/group/:groupId/file/:fileId/forever", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群文件转永久失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/private-file-url", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取私聊文件资源链接失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/flash-upload", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "上传闪传文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/flash-download", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "下载闪传文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/flash-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取闪传文件详情失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/download", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "下载文件到缓存目录失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/reshare_flash_file", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "重新分享闪传文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/rename_group_file", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "重命名群文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
