...
func RegisterGroupRoutes(r *gin.RouterGroup, ll *services.LLOneBotService, base *zap.Logger) {
	...
	r.GET("/list", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.GET("/:groupId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/member/:userId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群成员信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/members", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群成员列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.PUT("/:groupId/member/:userId/card", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群名片失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/:groupId/ban", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "群禁言失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.DELETE("/:groupId/member/:userId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "踢出群成员失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/:groupId/leave", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "退出群失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		msg := "已退出群"
		if body.Dismiss {
	...
	r.POST("/:groupId/admin", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置管理员失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.PUT("/:groupId/member/:userId/special-title", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群员头衔失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/:groupId/whole-ban", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置全员禁言失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.PUT("/:groupId/name", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "修改群名称失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/add-request", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "处理加群请求失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/poke", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "群戳一戳失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/notice", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发布群公告失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/notices", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群公告失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/system-msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群系统消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/shut-list", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取被禁言群员列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/batch-delete-members", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "批量踢出群成员失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/honor-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群荣誉信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/essence-list", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群精华消息列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/set_essence_msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群精华消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/delete_essence_msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "移出群精华消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/at-all-remain", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取@全员剩余次数失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/sign", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "群打卡失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/msg-mask", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群消息接收方式失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.PUT("/:groupId/remark", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置群备注失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/:groupId/ignore-add-request", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取已过滤的加群通知失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/:groupId/json-card", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送群JSON卡片失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
