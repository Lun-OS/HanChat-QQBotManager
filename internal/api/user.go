...
func RegisterUserRoutes(r *gin.RouterGroup, ll *services.LLOneBotService, base *zap.Logger) {
	...
	r.GET("/login-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取登录信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.GET("/friends", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取好友列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/stranger-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取陌生人信息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.DELETE("/friend/:userId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "删除好友失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/like", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "点赞好友失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/friends-with-category", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取好友列表（带分组）失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/friend-add-request", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "处理好友申请失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.PUT("/friend/:userId/remark", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置好友备注失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/poke", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "好友戳一戳失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/profile-like", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取我赞过谁列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/profile-like-me", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取谁赞过我列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/avatar", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置头像失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/avatar/:userId", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取头像失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.GET("/robot-uin-range", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取官方机器人QQ号范围失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/friend/:userId/category", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "移动好友分组失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/doubt-friends-add-request", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取被过滤好友请求失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/doubt-friends-add-request/handle", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "处理被过滤好友请求失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
