...
func RegisterMessageRoutes(r *gin.RouterGroup, ll *services.LLOneBotService, base *zap.Logger) {
	...
	r.POST("/private", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送私聊消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/group", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送群消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res, "message": "消息发送成功"})
	})
	...
	r.POST("/forward/friend-single", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "转发单条好友消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/forward/group-single", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "转发单条群消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/delete_msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "撤回消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/get_msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取消息详情失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/get_forward_msg", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取转发消息内容失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.GET("/ai-characters", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取AI角色列表失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/group-at", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送群@消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/group-music-163", func(c *gin.Context) {
		...
		res, err := ll.SendGroupMsg(groupID, message)
		if err != nil {
			utils.BadGateway(c, "发送群音乐（网易云）失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/group-music-qq", func(c *gin.Context) {
		...
		res, err := ll.SendGroupMsg(groupID, message)
		if err != nil {
			utils.BadGateway(c, "发送群音乐（QQ音乐）失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/group-music-custom", func(c *gin.Context) {
		...
		res, err := ll.SendGroupMsg(groupID, message)
		if err != nil {
			utils.BadGateway(c, "发送群音乐（自定义）失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/voice-to-text", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "语音转文本失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/group-forward", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送群合并转发失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/friend-history", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取好友历史消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/group-history", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群历史消息失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/emoji-like", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "设置消息表情赞失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.DELETE("/emoji-like", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "取消消息表情赞失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/send_poke", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送戳一戳失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/private-forward", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "发送私聊合并转发失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/file-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取消息文件详情失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/image-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取消息图片详情失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/record-info", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取消息语音详情失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		respondWithData(c, res)
	})
	...
	r.POST("/mark_msg_as_read", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "标记消息已读失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
	...
	r.POST("/upload/group-file", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "上传群文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
	...
	r.POST("/upload/private-file", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "上传私聊文件失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res, "message": "文件上传成功"})
	})
	...
	r.POST("/group-file-url", func(c *gin.Context) {
		...
		if err != nil {
			utils.BadGateway(c, "获取群文件URL失败（账号: "+ll.GetSelfID()+"）: "+err.Error())
			return
		}
		c.JSON(http.StatusOK, gin.H{"success": true, "data": res})
	})
