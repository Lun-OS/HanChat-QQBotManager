...
type PluginConfig struct {
	...
	MaxFileSize           int64            `mapstructure:"maxFileSize"` // 插件文件操作最大大小（字节），默认128MB
}
...
func LoadConfig() *Config {
	...
	v.SetDefault("plugin.maxFileSize", getEnvInt64("PLUGIN_MAX_FILE_SIZE", 128*1024*1024)) // 默认128MB
